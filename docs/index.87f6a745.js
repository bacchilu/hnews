 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nr(e){return 1e3*Number(e)}function rr(e){var t;const[n,r,i]=e.split(".");if(void 0===n||void 0===r||void 0===i)return Cn("JWT malformed, contained fewer than 3 sections"),null;try{const e=Xe(r);return e?JSON.parse(e):(Cn("Failed to decode base64 JWT payload"),null)}catch(e){return Cn("Caught error parsing JWT payload as JSON",null===(t=e)||void 0===t?void 0:t.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ti="recaptcha";async function Ci(e,t,n){var r;const i=await n.verify();try{let a;if(Dn("string"==typeof i,e,"argument-error"),Dn(n.type===Ti,e,"argument-error"),a="string"==typeof t?{phoneNumber:t}:t,"session"in a){const t=a.session;if("phoneNumber"in a){Dn("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
