...
n=u,eC))try{let e=new URL(window.location.href),t=new URL(u.startsWith("//")?e.protocol+u:u),n=W(t.pathname,f);t.origin===e.origin&&null!=n?u=n+t.search+t.hash:h=!0}catch(e){}// Rendered into <a href> for relative URLs
let p=/**
 * Returns the full href for the given "to" value. This is useful for building
 * custom links that are also accessible and preserve right-click behavior.
 *
 * @see https://reactrouter.com/hooks/use-href
 */function(e,t){let{relative:n}=void 0===t?{}:t;eo()||j(!1);let{basename:r,navigator:i}=D.useContext(en),{hash:a,pathname:o,search:s}=eu(e,{relative:n}),l=o;return"/"!==r&&(l="/"===o?r:G([r,o])),i.createHref({pathname:l,search:s,hash:a})}(u,{relative:i}),m=/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rE(e,t,n=!1){let r="signIn"/* OperationType.SIGN_IN */,i=await rk(e,r,t),a=await ry._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(a.user),a}new WeakMap;const rI="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */const iw="webStorageSupport",ik=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=rx,this._completeRedirectFn=r7,this._overrideRedirectResult=r6}// Wrapping in async even though we don't await anywhere in order
 ...
 *
 * @public
 */function(e,t){let n=tU(e,"auth");if(n.isInitialized()){let e=n.getImmediate(),r=n.getOptions();if(e9(r,null!=t?t:{}))return e;t5(e,"already-initialized"/* AuthErrorCode.ALREADY_INITIALIZED */)}let r=n.initialize({options:t});return r}(e,{popupRedirectResolver:ik,persistence:[rB,rT,rx]}),r=e2("authTokenSyncURL");if(r){let e=iO(r);ta(n).beforeAuthStateChanged(e,()=>e(n.currentUser)),ta(n).onIdTokenChanged(t=>e(t),void 0,void 0)}let i=e0("auth");return i&&/**
...
f({_c:i0})}),i){if(d)throw i;return}return y}}const a_=(e,t)=>{for(let n in e)e[n][0]&&e[n][0](t)},aS=(e,t)=>{// The global state for a specific provider will be used to deduplicate
...
(!j||!!i2(F))&&(M&&!i2(s)?s:!E().isPaused()&&(a?!i2(z)&&l:i2(z)||l)),B=!!(v&&t&&M&&$),W=i2(A.isValidating)?B:A.isValidating,K=i2(A.isLoading)?B:A.isLoading,q=(0,D.useCallback)(async e=>{let t,r;let a=_.current;if(!v||!a||w.current||E().isPaused())return!1;let o=!0,s=e||{},l=!m[v]||!s.dedupe,u=()=>ad?!w.current&&v===k.current&&b.current:v===k.current,c={isValidating:!1,isLoading:!1},d=()=>{T(c)},f=()=>{// Check if it's still the same request before deleting it.
...
[v,r]),Q=(0,D.useCallback)((...e)=>ak(r,k.current,...e),[]);// In Suspense mode, we can't return the empty `data` state.
