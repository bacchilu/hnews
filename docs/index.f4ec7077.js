 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const tx="@firebase/app",tN="0.9.23",tP=new th("@firebase/app"),tR="[DEFAULT]",tO={[tx]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},tL=new Map,tD=new Map;/**
 *
...
0===t&&e.createObjectStore(tH)}}).catch(e=>{throw tj.create("idb-open"/* AppError.IDB_OPEN */,{originalErrorMessage:e.message})})),t$}async function tW(e){try{let t=await tB(),n=await t.transaction(tH).objectStore(tH).get(tq(e));return n}catch(e){if(e instanceof e3)tP.warn(e.message);else{let t=tj.create("idb-get"/* AppError.IDB_GET */,{originalErrorMessage:null==e?void 0:e.message});tP.warn(t.message)}}}async function tK(e,t){try{let n=await tB(),r=n.transaction(tH,"readwrite"),i=r.objectStore(tH);await i.put(t,tq(e)),await r.done}catch(e){if(e instanceof e3)tP.warn(e.message);else{let t=tj.create("idb-set"/* AppError.IDB_WRITE */,{originalErrorMessage:null==e?void 0:e.message});tP.warn(t.message)}}}function tq(e){return`${e.name}!${e.options.appId}`}class tQ{constructor(e){this.container=e,/**
     ...
     */async triggerHeartbeat(){var e;let t=this.container.getProvider("platform-logger").getImmediate(),n=t.getPlatformInfoString(),r=tG();return(// Do not store a heartbeat if one is already stored for this day
...
tV("fire-js",""),tV("firebase","10.6.0","app"),"function"==typeof SuppressedError&&SuppressedError;const t0=new e4("auth","Firebase",tZ()),t1=new th("@firebase/auth");function t2(e,...t){t1.logLevel<=I.ERROR&&t1.error(`Auth (${tz}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nP(e,t){t5("string"==typeof e||void 0===e,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */,{appName:t})}class nR{constructor(e){var{uid:t,auth:n,stsTokenManager:r}=e,i=tX(e,["uid","auth","stsTokenManager"]);// For the user object, provider is always Firebase.
...
apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var n,r,i,a,o,s,l,u;let c=null!==(n=t.displayName)&&void 0!==n?n:void 0,d=null!==(r=t.email)&&void 0!==r?r:void 0,f=null!==(i=t.phoneNumber)&&void 0!==i?i:void 0,h=null!==(a=t.photoURL)&&void 0!==a?a:void 0,p=null!==(o=t.tenantId)&&void 0!==o?o:void 0,m=null!==(s=t._redirectEventId)&&void 0!==s?s:void 0,g=null!==(l=t.createdAt)&&void 0!==l?l:void 0,v=null!==(u=t.lastLoginAt)&&void 0!==u?u:void 0,{uid:y,emailVerified:b,isAnonymous:w,providerData:_,stsTokenManager:k}=t;t5(y&&k,e,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */);let S=nN.fromJSON(this.name,k);t5("string"==typeof y,e,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */),nP(c,e.name),nP(d,e.name),t5("boolean"==typeof b,e,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */),t5("boolean"==typeof w,e,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */),nP(f,e.name),nP(h,e.name),nP(p,e.name),nP(m,e.name),nP(g,e.name),nP(v,e.name);let E=new nR({uid:y,auth:e,email:d,emailVerified:b,displayName:c,isAnonymous:w,photoURL:h,phoneNumber:f,tenantId:p,stsTokenManager:S,createdAt:g,lastLoginAt:v});return _&&Array.isArray(_)&&(E.providerData=_.map(e=>Object.assign({},e))),m&&(E._redirectEventId=m),E}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nO=new Map;function nL(e){e instanceof Function||t9("Expected a class definition");let t=nO.get(e);return t?t instanceof e||t9("Instance stored in cache mismatched with class"):(t=new e,nO.set(e,t)),t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function nj(e){let t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera"/* BrowserName.OPERA */;{if(nV(t))return"IEMobile"/* BrowserName.IEMOBILE */;if(t.includes("msie")||t.includes("trident/"))return"IE"/* BrowserName.IE */;if(t.includes("edge/"))return"Edge"/* BrowserName.EDGE */;if(nU(t))return"Firefox"/* BrowserName.FIREFOX */;if(t.includes("silk/"))return"Silk"/* BrowserName.SILK */;if(n$(t))return"Blackberry"/* BrowserName.BLACKBERRY */;if(nB(t))return"Webos"/* BrowserName.WEBOS */;if(nz(t))return"Safari"/* BrowserName.SAFARI */;if((t.includes("chrome/")||nF(t))&&!t.includes("edge/"))return"Chrome"/* BrowserName.CHROME */;if(nH(t))return"Android"/* BrowserName.ANDROID */;let n=e.match(/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/);if((null==n?void 0:n.length)===2)return n[1]}return"Other"/* BrowserName.OTHER */}function nU(e=e2()){return/firefox\//i.test(e)}function nz(e=e2()){let t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function nF(e=e2()){return/crios\//i.test(e)}function nV(e=e2()){return/iemobile/i.test(e)}function nH(e=e2()){return/android/i.test(e)}function n$(e=e2()){return/blackberry/i.test(e)}function nB(e=e2()){return/webos/i.test(e)}function nW(e=e2()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function nK(e=e2()){// TODO: implement getBrowserName equivalent for OS.
return nW(e)||nH(e)||nB(e)||n$(e)||/windows phone/i.test(e)||nV(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */async function nG(e,t={}){return ns(e,"GET"/* HttpMethod.GET */,"/v2/passwordPolicy"/* Endpoint.GET_PASSWORD_POLICY */,no(e,t))}/**
 * Stores password policy requirements and provides password validation against the policy.
 *
 * @internal
 */class nJ{constructor(e){var t,n,r,i;// Only include custom strength options defined in the response.
 ...
 *     as a proxy.
 * @param onNoObservers Callback when count of Observers goes to zero.
 */function(e,t){let n=new tt(e,void 0);return n.subscribe.bind(n)}(e=>this.observer=e)}get next(){return t5(this.observer,this.auth,"internal-error"/* AuthErrorCode.INTERNAL_ERROR */),this.observer.next.bind(this.observer)}}function nZ(e){// TODO: consider adding timeout support & cancellation
...
async function n5(e,t){return ns(e,"POST"/* HttpMethod.POST */,"/v1/accounts:signUp"/* Endpoint.SIGN_UP */,t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class rd{constructor(){/**
     ...
     * @returns - The auth provider credential.
     */static credentialWithLink(e,t){let n=rc.parseLink(t);return t5(n,"argument-error"/* AuthErrorCode.ARGUMENT_ERROR */),rt._fromEmailAndCode(e,n.code,n.tenantId)}}/**
 * Always set to {@link ProviderId}.PASSWORD, even for email link.
 ...
 */function rq(e,t){return t?nL(t):(t5(e._popupRedirectResolver,e,"argument-error"/* AuthErrorCode.ARGUMENT_ERROR */),e._popupRedirectResolver)}/** Always set to {@link ProviderId}.PHONE. */rK.PROVIDER_ID="phone"/* ProviderId.PHONE */,/** Always set to {@link SignInMethod}.PHONE. */rK.PHONE_SIGN_IN_METHOD="phone"/* SignInMethod.PHONE */;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.resolve(null);return}if(e.eventId){let t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function r3(e,t){let n=r5(t),r=r8(e);if(!await r._isAvailable())return!1;let i=await r._get(n)==="true";return await r._remove(n),i}async function r4(e,t){return r8(e)._set(r5(t),"true")}function r6(e,t){r1.set(e._key(),t)}function r8(e){return nL(e._redirectPersistence)}function r5(e){return nA("pendingRedirect",e.config.apiKey,e.name)}async function r9(e,t,n){let r=tr(e);!function(e,t,n){if(!(t instanceof n))throw n.name!==t.constructor.name&&t3(e,"argument-error"/* AuthErrorCode.ARGUMENT_ERROR */),t6(e,"argument-error"/* AuthErrorCode.ARGUMENT_ERROR */,`Type of ${t.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}(e,t,rf),// Wait for auth initialization to complete, this will process pending redirects and clear the
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const id=new nt(5e3,15e3),ih={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},ip=new Map([["identitytoolkit.googleapis.com"/* DefaultConfig.API_HOST */,"p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]// test
...
n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){let t=await im(e),n=new ie(e);return t.register("authEvent",t=>{t5(null==t?void 0:t.authEvent,e,"invalid-auth-event"/* AuthErrorCode.INVALID_AUTH_EVENT */);// TODO: Consider splitting redirect and popup events earlier on
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node"/* ClientPlatform.NODE */:return"node";case"ReactNative"/* ClientPlatform.REACT_NATIVE */:return"rn";case"Worker"/* ClientPlatform.WORKER */:return"webworker";case"Cordova"/* ClientPlatform.CORDOVA */:return"cordova";default:return}}(h)),tV(iT,ix,"esm2017");const iL=tF({apiKey:"AIzaSyAC-lbWPT-60lPwbJGBMKp_1mLKWCljW4A",authDomain:"hnews-f845a.firebaseapp.com",projectId:"hnews-f845a",storageBucket:"hnews-f845a.appspot.com",messagingSenderId:"734364993587",appId:"1:734364993587:web:f0020375ba6ff35b8efb46"}),iD=function(e){let t=/**
 ...
 *
 * @public
 */function(e,t){let n=tM(e,"auth");if(n.isInitialized()){let e=n.getImmediate(),r=n.getOptions();if(e8(r,null!=t?t:{}))return e;t3(e,"already-initialized"/* AuthErrorCode.ALREADY_INITIALIZED */)}let r=n.initialize({options:t});return r}(e,{popupRedirectResolver:i_,persistence:[rB,rT,rx]}),r=e0("authTokenSyncURL");if(r){let e=iO(r);tr(n).beforeAuthStateChanged(e,()=>e(n.currentUser)),tr(n).onIdTokenChanged(t=>e(t),void 0,void 0)}let i=eX("auth");return i&&/**
