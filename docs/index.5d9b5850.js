...
n=u,eC))try{let e=new URL(window.location.href),t=new URL(u.startsWith("//")?e.protocol+u:u),n=H(t.pathname,h);t.origin===e.origin&&null!=n?u=n+t.search+t.hash:p=!0}catch(e){}// Rendered into <a href> for relative URLs
let m=/**
 * Returns the full href for the given "to" value. This is useful for building
 * custom links that are also accessible and preserve right-click behavior.
 *
 * @see https://reactrouter.com/hooks/use-href
 */function(e,t){let{relative:n}=void 0===t?{}:t;eo()||j(!1);let{basename:r,navigator:i}=D.useContext(en),{hash:a,pathname:o,search:s}=eu(e,{relative:n}),l=o;return"/"!==r&&(l="/"===o?r:Q([r,o])),i.createHref({pathname:l,search:s,hash:a})}(u,{relative:i}),g=/**
 ...
 *
 * @public
 */function(e,t){let n=tU(e,"auth");if(n.isInitialized()){let e=n.getImmediate(),r=n.getOptions();if(e9(r,null!=t?t:{}))return e;t8(e,"already-initialized"/* AuthErrorCode.ALREADY_INITIALIZED */)}let r=n.initialize({options:t});return r}(e,{popupRedirectResolver:i_,persistence:[rW,rT,rx]}),r=e2("authTokenSyncURL");if(r){let e=iO(r);ta(n).beforeAuthStateChanged(e,()=>e(n.currentUser)),ta(n).onIdTokenChanged(t=>e(t),void 0,void 0)}let i=e0("auth");return i&&/**
...
(!j||!!i2(F))&&(M&&!i2(s)?s:!E().isPaused()&&(a?!i2(z)&&l:i2(z)||l)),W=!!(v&&t&&M&&B),H=i2(A.isValidating)?W:A.isValidating,K=i2(A.isLoading)?W:A.isLoading,q=(0,D.useCallback)(async e=>{let t,r;let a=k.current;if(!v||!a||w.current||E().isPaused())return!1;let o=!0,s=e||{},l=!m[v]||!s.dedupe,u=()=>ad?!w.current&&v===_.current&&b.current:v===_.current,c={isValidating:!1,isLoading:!1},d=()=>{T(c)},f=()=>{// Check if it's still the same request before deleting it.
